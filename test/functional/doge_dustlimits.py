...
class DustLimitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.generatetoaddress(self.nodes[2], 1, node_addrs[2])
        self.generatetoaddress(self.nodes[0], 101, node_addrs[0])
        for addr in addrs:
        ...
        self.generatetoaddress(self.nodes[1], 1, node_addrs[1], sync_fun=self.no_op)
        self.sync_blocks()
        ...
        self.generatetoaddress(self.nodes[0], 1, node_addrs[0], sync_fun=self.no_op)
        self.sync_blocks()
        ...
        self.generatetoaddress(self.nodes[2], 1, node_addrs[2], sync_fun=self.no_op)
        self.sync_all()
    ...
    def create_dusty_tx(self, n, dust, fee):
        ...
        return n.signrawtransactionwithwallet(rawtx)
    ...
    def get_dust_rejection(self, n, dust, fee):
        rawtx = self.create_dusty_tx(n, dust, fee)
        assert_raises_rpc_error(-26, "dust", n.sendrawtransaction, rawtx['hex'])
