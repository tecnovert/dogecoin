...
BOOST_AUTO_TEST_CASE(rpc_ban)
{
    ...
    int64_t banned_until{o1.find_value("banned_until").get_int64()};
    ...
    o1 = ar[0].get_obj();
    adr = o1.find_value("address");
    banned_until = o1.find_value("banned_until").get_int64();
    const int64_t ban_created{o1.find_value("ban_created").get_int64()};
    const int64_t ban_duration{o1.find_value("ban_duration").get_int64()};
    const int64_t time_remaining{o1.find_value("time_remaining").get_int64()};
    BOOST_CHECK_EQUAL(adr.get_str(), "127.0.0.0/24");
