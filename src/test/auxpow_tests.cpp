...
BOOST_AUTO_TEST_CASE(check_auxpow)
{
    ...
    ap_test = builder.get();
    BOOST_CHECK(checkAuxPow(ap_test, hashAux, ourChainId, params));
    ...
    ap_test = builder.get();
    BOOST_CHECK(!checkAuxPow(ap_test, modifiedAux, ourChainId, params));
    ap_test = builder.get();
    BOOST_CHECK(!checkAuxPow(ap_test, hashAux, ourChainId + 1, params));
    ...
    BOOST_CHECK(checkAuxPow(auxpow, hashAux, ourChainId, params));
